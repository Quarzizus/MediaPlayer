...
var autoPause = /*#__PURE__*/function () {
  ...
  _createClass(autoPause, [{
    ...
    value: function run(player) {
      ...
      observer.observe(this.player.media); // Evento de cambiar de pestalla
    ...
    value: function handler(entries) {
      var entry = entries[0];
      var visibly = entry.intersectionRatio >= this.threshold;
    ...
    key: "handlerVisibly",
    value: function handlerVisibly() {
      var visibly = document.visibilityState == "visible";
...
var _autoPlay = _interopRequireDefault(require("../assets/plugins/autoPlay.js"));

var _autoPause = _interopRequireDefault(require("../assets/plugins/autoPause.js"));
...
var botonm = document.querySelector("#mute"); // creamos la instancia
...
},{"./MediaPlayer.js":"assets/MediaPlayer.js","../assets/plugins/autoPlay.js":"assets/plugins/autoPlay.js","../assets/plugins/autoPause.js":"assets/plugins/autoPause.js","/home/zizu/profesionalJS/sw.js":[["sw.js","sw.js"],"sw.js.map","sw.js"]}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "35779" + '/');
